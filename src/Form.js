                ...
                <div className="documents-upload-wrap">
                  ...
                  <ul className="nav nav-tabs" id="myTab" role="tablist">
                    <li className="nav-item" role="presentation">
                      <a className="nav-link active" id="passport-tab" data-toggle="tab" href="#passport" role="tab" aria-controls="passport" aria-selected="true"><img src="/assets/images/passport.png" alt="abdush" />passport</a>
                    </li>
                    <li className="nav-item" role="presentation">
                      <a className="nav-link" id="nid-tab" data-toggle="tab" href="#nid" role="tab" aria-controls="nid" aria-selected="false"><img src="/assets/images/nid.png" alt="abdush" />National id</a>
                    </li>
                    <li className="nav-item" role="presentation">
                      <a className="nav-link" id="driver-tab" data-toggle="tab" href="#driver" role="tab" aria-controls="driver" aria-selected="false"><img src="/assets/images/driving.png" alt="abdush" />Driver’s License</a>
                    </li>
                  </ul>
                      ...
                      <div className="documents-upload">
                        <div className="upload-item">
                          ...
                          <label className="btn-upload" htmlFor="input1" role="button">
                            <img src="/assets/images/cloud.png" alt="abdush" />
                            <div id="p-input1" className="preview-box" />
                          </label>
                          <div className="upload-direction"><span className="text">Passport Cover</span><a href="#"><img src="/assets/images/download.png" alt="abdush" /></a></div>
                        </div>
                        <div className="upload-item">
                          ...
                          <div className="upload-direction"><span className="text">Passport Data Page</span><a href="#"><img src="/assets/images/download.png" alt="abdush" /></a></div>
                        </div>
                        <div className="upload-item">
                          ...
                          <div className="upload-direction"><span className="text">Selfie With Passport</span><a href="#"><img src="/assets/images/download.png" alt="abdush" /></a></div>
                        </div>
                      </div>
                    ...
                    <div className="tab-pane fade" id="nid" role="tabpanel" aria-labelledby="nid-tab">
                      <div className="documents-upload">
                        <div className="upload-item">
                          ...
                          <div className="upload-direction"><span className="text">National ID Front</span><a href="#"><img src="/assets/images/download.png" alt="abdush" /></a></div>
                        </div>
                        <div className="upload-item">
                          ...
                          <div className="upload-direction"><span className="text">National ID Back</span><a href="#"><img src="/assets/images/download.png" alt="abdush" /></a></div>
                        </div>
                        <div className="upload-item">
                          ...
                          <div className="upload-direction"><span className="text">Selfie With National ID</span><a href="#"><img src="/assets/images/download.png" alt="abdush" /></a></div>
                        </div>
                      </div>
                      <div className="conditions">
                        <ul>
                    ...
                    <div className="tab-pane fade" id="driver" role="tabpanel" aria-labelledby="driver-tab">
                      <div className="documents-upload">
                        <div className="upload-item">
                          ...
                          <div className="upload-direction"><span className="text">License Front</span><a href="#"><img src="/assets/images/download.png" alt="abdush" /></a></div>
                        </div>
                        <div className="upload-item">
                          ...
                          <div className="upload-direction"><span className="text">License Back</span><a href="#"><img src="/assets/images/download.png" alt="abdush" /></a></div>
                        </div>
                        <div className="upload-item">
                          ...
                          <div className="upload-direction"><span className="text">Selfie With License</span><a href="#"><img src="/assets/images/download.png" alt="abdush" /></a></div>
                        </div>
                      </div>
                      <div className="conditions">
                        <ul>
